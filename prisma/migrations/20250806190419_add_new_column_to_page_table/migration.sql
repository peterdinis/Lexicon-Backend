...
INSERT INTO "new_Page" ("createdAt", "id", "isDatabase", "ownerId", "parentPageId", "title", "updatedAt", "workspaceId") SELECT "createdAt", "id", "isDatabase", "ownerId", "parentPageId", "title", "updatedAt", "workspaceId" FROM "Page";
DROP TABLE "Page";
